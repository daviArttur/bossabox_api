...
import { FindToolsController } from './find-tools';

describe('test FindToolsController', () => {
  let controller: FindToolsController;
  ...
  beforeEach(() => {
    ...
    controller = new FindToolsController(usecaseStub);
  });
